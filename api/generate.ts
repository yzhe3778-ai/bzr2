...
type ThemeStyle = 'classic' | 'zootopia' | 'spongebob' | 'demon-slayer' | 'minions' | 'harry-potter';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    const { teacherName, studentName, themeId, keywords } = req.body;
    ...
    【核心信息】
    - 教师（发件人）：${teacherName}
    - 主题风格：${themeNames[themeId as ThemeStyle] || themeId}
